...
while len(house.data.color_attributes):
    house.data.color_attributes.remove(house.data.color_attributes[0])
col = house.data.color_attributes.new(name="ao", type='FLOAT_COLOR', domain='CORNER')
house.data.color_attributes.active_color = col
...
try:
    ...
    data = house.data.color_attributes["ao"].data
    for i in range(len(data)):
        c = data[i].color
        ao = 0.34 + 0.66 * c[0]      # keep some light in the crevices
